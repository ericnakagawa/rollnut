...
var Rollnut = function() {

};

Rollnut.Boot = function() {

};

Rollnut.Boot.prototype = {
	preload: function() {
	...
	create: function() {
		...
		if (this.game.device.desktop) {
			...
			this.scale.minWidth = gameWidth/2;
			this.scale.minHeight = gameHeight/2;
			this.scale.maxWidth = 2000; //You can change this to gameWidth*2.5 if needed
			this.scale.maxHeight = 1200; //Make sure these values are proportional to the gameWidth and gameHeight
			this.scale.pageAlignHorizontally = true;
			this.scale.pageAlignVertically = true;
